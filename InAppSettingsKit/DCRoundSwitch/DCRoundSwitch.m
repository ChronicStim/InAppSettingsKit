...
- (void)sizeToFit
{
    ...
    NSDictionary* attributes = @{NSFontAttributeName: self.toggleLayer.labelFont};
	CGFloat width = [onString sizeWithAttributes:attributes].width;
	CGFloat offWidth = [offString sizeWithAttributes:attributes].width;
